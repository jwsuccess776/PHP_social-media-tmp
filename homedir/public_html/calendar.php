...
var STR_ICONPATH = '<?php echo $CONST_IMAGE_ROOT ?>/cal/';

var dt_current = new Date(<?=$datetime;?>);
//alert(dt_current);
var num_id = "<?=$id;?>";
...
if (obj_caller && obj_caller.year_scroll) {
        ...
        prev_year = dt_prev_year.getFullYear() - 1;
//        alert(dt_current.getDate());
        dt_prev_year.setFullYear(prev_year);
...
//    alert(obj_caller);
        ...
        if (b_close) {
                window.close();
                obj_caller.set_date(dt_datetime);
        }
...
while (dt_current_day.getMonth() == dt_current.getMonth() ||
        ...
        // print row heder
        document.write('<tr>');
//            alert(dt_current_day.getFullYear());
        for (var n_current_wday=0; n_current_wday<7; n_current_wday++) {
                if (dt_current_day.getDate() == obj_caller.day &&
                        dt_current_day.getMonth() == obj_caller.month-1 &&
                        dt_current_day.getFullYear() == obj_caller.year)
                        // print current date
