...
switch ($mode) {
        ...
        case 'fetch':
            ...
            $lstUserid=sanitizeData($_POST['lstUsername'], 'xss_clean');   
...
//            restrict_demo();
          $lstUsername=  sanitizeData($_POST['lstUsername'], 'xss_clean');  
            ...
            $lstUsername=mysqli_real_escape_string($globalMysqlConn, $lstUsername);
            ...
            $surname=sanitizeData($_POST['txtSurname'], 'xss_clean'); 
            $surname=mysqli_real_escape_string($globalMysqlConn, $surname);
            
            $forename=sanitizeData($_POST['txtForename'], 'xss_clean'); 
            $forename=mysqli_real_escape_string($globalMysqlConn, $forename);
            
            $website=sanitizeData($_POST['txtWebsite'], 'xss_clean'); 
            $website=mysqli_real_escape_string($globalMysqlConn, $website);

            $email=sanitizeData($_POST['txtEmail'], 'xss_clean'); 
            $email=mysqli_real_escape_string($globalMysqlConn, $email);


            $address=sanitizeData($_POST['txtAddress'], 'xss_clean'); 
            $address=mysqli_real_escape_string($globalMysqlConn,$address);

            $street=sanitizeData($_POST['txtStreet'], 'xss_clean'); 
            $street=mysqli_real_escape_string($globalMysqlConn, $street);

            $town=sanitizeData($_POST['txtTown'], 'xss_clean'); 
            $town=mysqli_real_escape_string($globalMysqlConn,$town);

            $email=sanitizeData($_POST['txtEmail'], 'xss_clean'); 
            $state=mysqli_real_escape_string($globalMysqlConn, $_POST['txtState']);

            $zipcode=sanitizeData($_POST['txtZipcode'], 'xss_clean'); 
            $zipcode=mysqli_real_escape_string($globalMysqlConn, $zipcode);

            $country=sanitizeData($_POST['txtCountry'], 'xss_clean'); 
            $country=mysqli_real_escape_string($globalMysqlConn,$country);

            $business=sanitizeData($_POST['txtBusiness'], 'xss_clean'); 
            $business=mysqli_real_escape_string($globalMysqlConn, $business);

            $fax=sanitizeData($_POST['txtFax'], 'xss_clean'); 
            $fax=mysqli_real_escape_string($globalMysqlConn, $fax);
            
            $payname=sanitizeData($_POST['txtPayname'], 'xss_clean'); 
            $payname=mysqli_real_escape_string($globalMysqlConn, $payname);

            $telephone=sanitizeData($_POST['txtTelephone'], 'xss_clean'); 
