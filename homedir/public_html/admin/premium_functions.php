...

{
    ...
    $name = mysqli_real_escape_string($globalMysqlConn,$name);
    
    $uri=sanitizeData($_POST['uri'], 'xss_clean'); 
    $uri = mysqli_real_escape_string($globalMysqlConn,$uri);
...

{
    ...
    $prf_id =sanitizeData(trim($_GET['prf_id']), 'xss_clean');  
