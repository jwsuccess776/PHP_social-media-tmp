...

{
   ...
   $psp_service= sanitizeData(trim($_GET['psp_service']), 'xss_clean');  
    $query = "  SELECT *

                FROM payment_service_params

                WHERE psp_service = '".$psp_service."'";
    ...
    $query = "UPDATE payment_service_params SET psp_type = '$type' WHERE psp_service='".$psp_service."'";
