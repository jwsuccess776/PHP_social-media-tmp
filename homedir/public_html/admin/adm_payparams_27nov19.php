...
if($_POST['act']) {
    ...
    if($_POST['act'] == "save_main_settings") {
        ...
        $sql_query = "UPDATE payment_systems SET ps_max_amount = '".$_POST['max_amount']."' WHERE ps_id = '".$_POST['ps_id']."'";
...
$pay_service = ($_REQUEST['pay_service']) ? $_REQUEST['pay_service'] : 'premium';



$query = "SELECT * FROM payment_systems WHERE ps_id = '".$_REQUEST['ps_id']."'";
    ...
    <tr>
        ...
        <td>
            ...
            <table border="0" width="100%" cellpadding="2" cellspacing="10">
                ...
                <input type="hidden" name="ps_id" value="<?=$_REQUEST['ps_id']?>">
