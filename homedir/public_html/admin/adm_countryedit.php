...
if(sanitizeData($_POST['act'], 'xss_clean')) {
    ...
    $gcn_name=sanitizeData($_POST['gcn_name'], 'xss_clean');
    $gcn_order=sanitizeData($_POST['gcn_order'], 'xss_clean');
    $country_id=sanitizeData($_POST['country_id'], 'xss_clean');

    $sql_query = "UPDATE geo_country SET gcn_name = '$gcn_name', gcn_status = '$_status', gcn_order = '".$gcn_order."', gcn_regionid = '0' WHERE gcn_countryid = '".$country_id."'";
...
//print_r($sql_query);
 ...
 $country_id=sanitizeData($_REQUEST['country_id'], 'xss_clean');
$query = "SELECT * FROM geo_country WHERE gcn_countryid = '".$country_id."'";
