...
<table width="<?php print("$CONST_TABLE_WIDTH"); ?>" align="<?php print("$CONST_TABLE_ALIGN"); ?>" border="0" cellspacing="<?php print("$CONST_TABLE_CELLSPACING"); ?>" cellpadding="<?php print("$CONST_TABLE_CELLPADDING"); ?>">
    ...
    <tr>
      ...
      <td class="pageheader"><?php echo ADM_PAGETEMPLATES_SECTION_NAME ?></td>
  ...
  <tr>
    ...
    <tr class="tdtoprow" align="left">
      ...
      <td >
        ...
        foreach ($pagetemplate->GetList() as $row){
    ...
    <tr align=left class="tdodd" >
      ...
      <?foreach($lang->GetActiveList() as $lang_row){?>
        ...
        <a href="<?=$CONST_LINK_ROOT?>/admin/adm_pagetemplates_edit.php?Name=<?=$row->name?>&LANG_ID=<?=$lang_row->LangID?>">
