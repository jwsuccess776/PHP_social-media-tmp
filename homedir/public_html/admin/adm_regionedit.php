...
if($_POST[act]) {
      ...
      $grg_name=  sanitizeData($_POST['grg_name'], 'xss_clean');
      $grg_order=  sanitizeData($_POST['grg_order'], 'xss_clean');
      $region_id=  sanitizeData($_POST['region_id'], 'xss_clean');
      
//    $_status = (isset($_POST[gcn_status]))?1:0;
    $sql_query = "UPDATE geo_region SET grg_name = '$grg_name', grg_order = '$grg_order' WHERE grg_regionid = '$region_id'";
//print_r($sql_query);
  ...
  $region_id=  sanitizeData($_REQUEST['region_id'], 'xss_clean');
$query = "SELECT * FROM geo_region WHERE grg_regionid = '".$region_id."'";
