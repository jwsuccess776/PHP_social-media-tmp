...
if(!empty($list)) {
    foreach ($list as $id){
        ...
        $db->query("UPDATE members SET mem_confirm='1' WHERE mem_userid='$id'");
...
<table width="<?php print("$CONST_TABLE_WIDTH"); ?>" align="<?php print("$CONST_TABLE_ALIGN"); ?>" border="0" cellspacing="<?php print("$CONST_TABLE_CELLSPACING"); ?>" cellpadding="<?php print("$CONST_TABLE_CELLPADDING"); ?>">
  ...
  <tr>
    ...
    <td class="pageheader"><?php echo UNCONFIRMED_SECTION_NAME ?></td>
...
while ($row = mysqli_fetch_array($result)){?>
    ...
    <tr>
      ...
      <td width=32%><?=$row['mem_username']?></td>
...
<? } ?>
    ...
    <tr align=left>
      ...
      <td align=center colspan=4> <input type=submit name="Activate" value="<?=ADM_CONFIRM?>" class=button>&nbsp;<input type=submit name="Delete" value="<?=BUTTON_DELETEMEMBER?>" class=button onClick="return delete_alert4(); "></td>
