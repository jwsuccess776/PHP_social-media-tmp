...
$subscriptionId =sanitizeData($_POST['subscriptionId'], 'xss_clean') ;   
$cardNumber =sanitizeData($_POST['cardNumber'], 'xss_clean') ;   
$expirationDate =sanitizeData($_POST['expirationDate'], 'xss_clean') ;
$firstName =sanitizeData($_POST['firstName'], 'xss_clean') ;
$lastName =sanitizeData($_POST['lastName'], 'xss_clean') ; 
