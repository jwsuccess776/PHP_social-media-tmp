...
//$CONST_LINK_ROOT = get_domain_path_by_order_id($payment_id);
...
if ($_REQUEST['OK']){
    ...
    $AuthorizeNet->CustomerBilling($CC_FirstName, $CC_LastName, $CC_Address, $CC_City, $CC_State, $CC_ZipCode, $CC_Telephone, '', $CC_Country, '', $Sess_UserId, '', $AccountNumber."-".$InvoiceNumber);
