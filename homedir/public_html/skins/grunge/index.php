      ...
      ?>
        ...
        <div id="content_inner">
          ...
          <div id="home_content_top">
            <div id="home_slogan">
            <div id="home_join"><a href="<?=$CONST_LINK_ROOT?>/register.php"><img src="<?=$CONST_IMAGE_ROOT?>join.gif" alt="<?=$MENU_REGISTER?>" width="280" height="80" border="0" /></a></div>
            ...
            <div id="home_search">
              <table cellpadding="3">
                <form action="<?=$CONST_LINK_ROOT?>/prgminisearch.php" method="post" name="dating service" id="dating service">
                  <tr>
                    <td colspan="2" class="home_searchtitle"><?=HOME_SEARCH_TITLE?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td >&nbsp;</td>
                    <td ><input type="image" src="<?=$CONST_IMAGE_ROOT?>search.gif"  alt="<?=HOME_SEARCH_TITLE?>" name="search" /></td>
                  </tr>
                </form>
              </table>
            </div>
...
global $db;
        ...
        $res=mysqli_query($conSting,$query) or die(mysql_error());
        ...
        $res=mysqli_query($conSting,$query) or die(mysqli_error());
       ...
       // mysqli_close( $link );
        ...
        ?>
                <table id="home_profile">
                  <tr>
                    <td valign="top"><?php if (!empty($female1_id)) { ?>
                      ...
                      <div><a href="<?=$CONST_LINK_ROOT?>/prgretuser.php?userid=<?=$female1_id?>">
                        <?=$female1_name?>
                        ,
                        <?=$female1_age?>
                        <br />
                    ...
                    <td valign="top"><?php if (!empty($female2_id)) { ?>
                      <a href="<?=$CONST_LINK_ROOT?>/prgretuser.php?userid=<?=$female2_id?>" class="profile_image"><span><img src="<?=$CONST_LINK_ROOT?><?=$female2_picture?>" alt="" border="0" /></span></a>
                      <div><a href="<?=$CONST_LINK_ROOT?>/prgretuser.php?userid=<?=$female2_id?>">
                        <?=$female2_name?>
                        ,
                        <?=$female2_age?>
                        <br />
                    ...
                    <td valign="top"><?php if (!empty($male1_id)) { ?>
                      ...
                      <div><a href="<?=$CONST_LINK_ROOT?>/prgretuser.php?userid=<?=$male1_id?>">
                        <?=$male1_name?>
                        ,
                        <?=$male1_age?>
                        <br />
                    ...
                    <td valign="top"><?php if (!empty($male2_id)) { ?>
                      ...
                      <div><a href="<?=$CONST_LINK_ROOT?>/prgretuser.php?userid=<?=$male2_id?>">
                        <?=$male2_name?>
                        ,
                        <?=$male2_age?>
                        <br />
            ...
            <div id="home_right">
              <div class="home_content_header"><?=GENERAL_TAG_CLOUD?></div>
            <div class="home_content_body">
                <?include "tag_cloud.inc.php";?>
            </div>
            </div>
          </div>
