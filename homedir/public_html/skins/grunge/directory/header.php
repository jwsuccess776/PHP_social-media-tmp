    ...
    <tr>
      ...
      <td valign="top" width="20%" class="side"> <table width="100%"   border="0" cellspacing="0" cellpadding="5">
          ...
          <tr>
            ...
            $categories=mysqli_query($globalMysqlConn, "SELECT DISTINCT(cat_parent) FROM dir_categories");

            while ($directory_menu_top=mysqli_fetch_object($categories)) {
                ...
                $sub_categories=mysqli_query($globalMysqlConn, "SELECT cat_child, cat_id FROM dir_categories WHERE cat_parent = '$directory_menu_top->cat_parent'");



                while ($directory_menu=mysqli_fetch_object($sub_categories)) {
                    ...
                    if ($directory_menu->cat_child) {
                        ...
                        $link_res=mysqli_query($globalMysqlConn, "SELECT COUNT(*) AS total FROM dir_site_list WHERE cat_id=$directory_menu->cat_id AND site_sponsor='N'");



                        $site_list=mysqli_fetch_object($link_res);
