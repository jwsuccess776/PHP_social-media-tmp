...
<div class="container">
  ...
  <div id="header">
    ...
    <div id="header_left">
      ...
      <?php }	?>
          ...
          <div id="header_right" class="navbar-collapse bs-navbar-collapse collapse">
      ...
      <?=$MENU_HELP?>
          ...
          <nav class="navbar-collapse bs-navbar-collapse collapse in" id="site-navigation" itemscope="" itemtype="http://schema.org/SiteNavigationElement" style="height: auto;">
			<ul id="menu-mainnav" class="nav navbar-nav navbar-right responsive-nav main-nav-list">
                            <li id="menu-item-750" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home menu-item-750" href="<?=$CONST_LINK_ROOT?>/home.php">
  ...
  <div id="shadow_m">
    ...
    <div id="shadow_t">
      ...
      ?>
        ...
        <div id="content" class="home_content col-md-12">
            <div id="wrapperin">
          <div id="home_content_top">
            ...
            <div class="col-md-4 col-xs-12">
                <div id="home_search" class=" col-xs-4 col-sm-12 col-md-12" >
 ...
 <div id="content-bottom">
          ...
          <div id="home_content_lower">
              ...
              <div id="home_left" class="col-md-12 col-sm-12">
                
                 
                    <div class="home_content_top_header">Find the ideal match of your dreams!</div>
...
<?php
        ...
        <div id="footer">
          ...
          <div id="footer_inner">
            ...
            <div class="footer_cell col-xs-12 col-sm-4"><a class='forumlinks' href="<?php echo $CONST_LINK_ROOT?>/invitefriend.php">
