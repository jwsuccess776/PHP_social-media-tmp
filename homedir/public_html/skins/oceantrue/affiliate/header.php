...
<div id="wrapper">
  ...
  <div id="header">
    ...
    <div id="header_right">
      ...
      <?php if (isset($_SESSION['Sess_UserId'])){	?>
      <a class="home-nav" href="<?=$CONST_LINK_ROOT?>/home.php">
      <?=$MENU_HOME?>
      </a> | <a class="home-nav" href="<?=$CONST_LINK_ROOT?>/get_premium.php">
      <?=$MENU_UPGRADE?>
      </a> | <a class="home-nav" href="<?=$CONST_LINK_ROOT?>/logoff.php">
      <?=$MENU_LOGOUT?>
      </a> |
      <?php } else { ?>
      <a class="home-nav" href="<?=$CONST_LINK_ROOT?>/index.php">
      <?=$MENU_HOME?>
      </a> | <a class="home-nav" href="<?=$CONST_LINK_ROOT?>/register.php">
      <?=$MENU_REGISTER?>
      </a> | <a class="home-nav" href="<?=$CONST_LINK_ROOT?>/login.php">
      <?=$MENU_LOGIN?>
      </a> |
      <?php }	?>
