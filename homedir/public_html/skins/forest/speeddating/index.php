...
<script language="javascript" src="<?=$CONST_LINK_ROOT?>/geography.js" type="text/javascript"></script>
  ...
  <div id="content">
    ...
    <div id="content_inner">
        ...
        if ($event_qty > 0) {
            ...
            ?>
                  ...
                  <tr>
                    ...
                    <td colspan="6" class="home_tag_header"><?=SD_NEXT?> 
      ...
      <div id="home_right_sd">
        ...
        <table cellpadding="3">
          ...
          <form action="prgsubscribe_mail.php">
            ...
            <tr>
              ...
              <td colspan="2"  class="home_tag_header"><?=SD_INFORMED?></td>

            </tr>

            <tr>

              <td ><?=SD_TELLAFRIEND_EMAIL?></td>

              <td><input name='email' type="text" class="input" style="width:160px;" value='' /></td>

            </tr>

            <tr>

              <td ><?=ADM_EVENT_TICKETS_GENDER?></td>
            ...
            <tr>
              ...
              <td colspan="2" nowrap="nowrap"><input type="submit" class="button" name="subscribe_mail" value="<?=SD_INDEX_SUB?>" />
        ...
        <div class="home_tag_header"><?=SD_SPECIAL?></div>
        ...
        <div class="home_tag_header"><?=$MENU_STORIES?></div>
