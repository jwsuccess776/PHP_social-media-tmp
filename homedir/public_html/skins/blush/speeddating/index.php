  ...
  <div id="content">
    ...
    <div id="content_inner">
        ...
        if ($event_qty > 0) {
            ...
            ?>
                  ...
                  <tr>
                    ...
                    <td colspan="6" class="home_content_header"><?=SD_NEXT?> 
      ...
      <div id="home_right_sd">
        ...
        <table cellpadding="3">
          ...
          <form action="prgsubscribe_mail.php">
            ...
            <tr>
              ...
              <td colspan="2"  class="home_content_header"><?=SD_INFORMED?></td>
        ...
        <div class="home_content_header"><?=SD_SPECIAL?></div>
        ...
        <div class="home_content_header"><?=$MENU_STORIES?></div>
