...
<?=$skin->ShowHeader($area)?>
  <table width="<?php print("$CONST_TABLE_WIDTH"); ?>" align="<?php print("$CONST_TABLE_ALIGN"); ?>" border="0" cellspacing="<?php print("$CONST_TABLE_CELLSPACING"); ?>" cellpadding="<?php print("$CONST_TABLE_CELLPADDING"); ?>">
    ...
    <td class="pageheader"><?php echo INVITE_MAIN_SECTION_NAME ?></td>
    </tr>
    <tr>
      <td><table width="100%"  border="0" cellpadding="<?php print("$CONST_SUBTABLE_CELLPADDING"); ?>" cellspacing="<?php print("$CONST_SUBTABLE_CELLSPACING"); ?>">
      	<form method='post' action='<?php echo $CONST_LINK_ROOT?>/prginvitefriend.php' name="FrmTipMail">
          <tr>
          ...
          <tr class="tdodd">
            <td>
              <?=TIPAFRIEND_EMAIL?>
              1:</td>
            <td> <input type="text" class="input" name="txtEmail[]" size="50" tabindex="1"></td>
          </tr>
          <tr class="tdeven">
            <td>
              <?=TIPAFRIEND_EMAIL?>
