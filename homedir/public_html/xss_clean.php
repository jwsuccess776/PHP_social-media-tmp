	...
	*/
	function xss_clean($str, $is_image = FALSE)
	{
		...
		*/
		...
		//	echo 'afte pregreplace'.$str.'<br>'.$this->xss_hash().'<br>';
		/*
		...
		*
		* <?php href="http://%77%77%77%2E%67%6F%6F%67%6C%65%2E%63%6F%6D">Google</a>
		*
		* Note: Use rawurldecode() so it does not remove plus signs
		*
		*/
		$str = rawurldecode($str);
		//echo 'url decode str'.$str.'<br>';
		/*
		...
		*/
		...
		//echo 'preg_replace_callback='.$str.'<br>';
		$str = preg_replace_callback("/<\w+.*?(?=>|<|$)/si", array($this, '_html_entity_decode_callback'), $str);
	//	echo '_html_entity_decode_callback'.$str.'<br>';
		/*
		* Remove Invisible Characters Again!
		*/
		$str = $this->_remove_invisible_characters($str);
	//	echo '<br>remove_invisible_characters'.$str.'<br>';
		/*
