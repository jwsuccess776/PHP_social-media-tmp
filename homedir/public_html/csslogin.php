  ...
  <div id="boxtitle"></div>
		<table width="100%"  border="0" cellpadding="<?php print("$CONST_SUBTABLE_CELLPADDING"); ?>" cellspacing="<?php print("$CONST_SUBTABLE_CELLSPACING"); ?>">
          ...
          <tr >
            ...
            <td colspan="2" align="left" class="tdodd" > <input type="text" class="input" name="txtHandle" size="20" tabindex="1" value="<?php if(isset($_COOKIE['txtHandle_c'])) { echo $_COOKIE['txtHandle_c']; }?>">
            </td>
          </tr>
          <tr >
            <td align="left" class="tdeven"><?php echo LOGIN_PASSWORD ?></td>
            <td colspan="2" align="left" class="tdeven" > <input name="txtPassword" type="password" class="input" tabindex="2" value="<?php if(isset($_COOKIE['txtPassword_c'])) { echo $_COOKIE['txtPassword_c']; } ?>" size="20">
            </td>
          </tr>
          <tr >
