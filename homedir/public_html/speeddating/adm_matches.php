...
if (isset($_GET['uid1'])) $uid1=sanitizeData(trim($_GET['uid1']), 'xss_clean');   

if (isset($_POST['uid1'])) $uid1=sanitizeData(trim($_POST['uid1']), 'xss_clean'); 

if (isset($_GET['uid2'])) $uid2=sanitizeData(trim($_GET['uid2']), 'xss_clean');   

if (isset($_POST['uid2'])) $uid2=sanitizeData(trim($_POST['uid2']), 'xss_clean'); 
