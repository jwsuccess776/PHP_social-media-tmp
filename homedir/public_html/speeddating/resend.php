...
<table width="<?php print("$CONST_TABLE_WIDTH"); ?>" align="<?php print("$CONST_TABLE_ALIGN"); ?>" border="0" cellspacing="<?php print("$CONST_TABLE_CELLSPACING"); ?>" cellpadding="<?php print("$CONST_TABLE_CELLPADDING"); ?>">
    ...
    <tr>
      <td><table width="100%"  border="0" cellpadding="<?php print("$CONST_SUBTABLE_CELLPADDING"); ?>" cellspacing="<?php print("$CONST_SUBTABLE_CELLSPACING"); ?>">
        <form method="post" action="<?php echo $CONST_LINK_ROOT?>/speeddating/prgresend.php" name="FrmResend">
          <tr>
          ...
          <tr class="tdodd" >
            ...
            <td> <input name="txtEmail" type="text" class="input" tabindex="1" size="28">
          ...
          <tr align="center">
            <td colspan="2" class="tdfoot"> <input type="submit" name="resend" value="Resend" class=button>
            </td>
          </tr>
          <tr>
            <td colspan="2"> </td>
