...
if(isset($_POST['id']))
    ...
    $current_venue_id =sanitizeData(trim($_POST['id']), 'xss_clean');  

switch ($mode) {

    case 'update':

        $vnu_venueid =sanitizeData(trim($_POST['id']), 'xss_clean');   

        $vnu_name = form_get('name');

        $vnu_countryid =sanitizeData(trim($_POST['country']), 'xss_clean'); 

        $vnu_stateid =sanitizeData(trim($_POST['state']), 'xss_clean');  

        $vnu_cityid =sanitizeData(trim($_POST['city']), 'xss_clean');  
