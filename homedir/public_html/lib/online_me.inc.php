...
if ($sql_array->isOnline && $Sess_UserId != $sql_array->adv_userid) {
    ...
    if ($option_manager->GetValue('userplane_im')) {
        ...
        print('<a href="#" onClick="up_launchWM_free( \''.$Sess_UserId.'\', \''.$sql_array->adv_userid.'\' ); return false;" title="Launch IM Now!"><img border="0" src="'.$CONST_IMAGE_ROOT.'/online_im.gif" align="absmiddle"></a>');
