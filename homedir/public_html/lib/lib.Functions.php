<?php
 include_once($CONST_INCLUDE_ROOT.'/validation_functions.php');
/*
...
function createImageFromWebCamera($imgStr, $width, $height, $prefix){    $buf = Array();//    saveFile($imgStr); 
...
function FormGet($value){
    ...
    if (isset($_POST[$value])) {
        ...
        $get_value=sanitizeData($_POST[$value], 'xss_clean'); 
    ...
    elseif (isset($_GET[$value])) {
        ...
        $get_value=sanitizeData($_GET[$value], 'xss_clean');  
    ...
    elseif (isset($_SESSION[$value])) {
        ...
        $get_value=sanitizeData($_SESSION[$value], 'xss_clean');   
