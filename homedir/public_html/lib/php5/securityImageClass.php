...
public $inputParam = "";			// Public; $x->inputParam = "style='color:blue'"
public $name 	= "security";		// Public; $x->name = "mySecurityInputField"

public $codeLength = 5;			// Private; use setCodeLength()
public $fontSize	= 16;			// Private; use setFontSize()
...
public $securityCode = "";			// Private

function securityImage() {

    $key = array_rand($this->images);
    $this->fontColor = $this->images[$key]['fontColor'];
    $this->imageFile = $this->images[$key]['imageFile'];
    $this->imageFont = $this->images[$key]['imageFont'];
    session_start();
