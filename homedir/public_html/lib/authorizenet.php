...
class AuthorizeNet_Billing
{
        ...
        ************************************ */
        ...
        function ProcessTransaction () {
                ...
                "x_login" => "$this->login", // x_Login
                "x_tran_key" => "$this->trans_key", // x_Tran_Key
                "x_version" => "$this->version", // x_Version
                "x_type" => "$this->trans_type", // x_Type
                "x_method" => "$this->ccecheck", // x_Method
                "x_delim_char" => "$this->delim_char", // x_Delim_Char
                "x_delim_data" => "$this->delim_data", // x_Delim_Data
                "x_Encap_Char" => "$this->encaps_char",
                "x_amount" => "$this->amount", // x_Amount
                "x_description" => "$this->desc", // x_Description
                "x_card_num" => "$this->cc_num", // x_Card_Num
                "x_exp_date" => "$this->exp_date", // x_Exp_Date
