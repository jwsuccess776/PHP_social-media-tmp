...
$txtSchedule=sanitizeData($_POST['txtYear'], 'xss_clean')."/".
...
if ($txtApprove<> "")
    ...
    if ($txtApprove=="1")
        ...
        header("Location: $CONST_LINK_ROOT/approveevent.php");
        exit;
        }
    elseif ($txtApprove =='0')
        {
...
$query="INSERT INTO events (ev_eventname,
                        ...
                        ev_schedule, ev_phone, ev_website, ev_description, ev_picture)
