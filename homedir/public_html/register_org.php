...
<table width="100%"  border="0" cellspacing="<?php print("$CONST_SUBTABLE_CELLSPACING"); ?>" cellpadding="<?php print("$CONST_SUBTABLE_CELLPADDING"); ?>">
        <form method="post" enctype='multipart/form-data' action="<?php echo $CONST_LINK_ROOT?>/prgregister.php?mode=create" name="FrmRegister" onSubmit="return Validate_FrmRegister('create')" >
          ...
          <tr class="tdodd" >
            <td width="140" align="left" class="tdodd"><?php echo REGISTER_USERNAME?>:  <span class=mandatory>*</span></td>
            <td colspan="2" align="left" class="tdodd"> <input type="text"  name="txtHandle" size="20" maxlength='25' class="input" value="<?=$_SESSION['post']['txtHandle'];?>" >
            ...
            <td colspan="1" rowspan="<?php echo $rows ?>" align="left" valign="top" class="tdcontent"><p>
                <?php echo REGISTER_MANDATORY?>  <span class=mandatory>*</span></p>
              <p><?php echo REGISTER_DESCRIPTION?></p></td>
          </tr>
          <tr >
          ...
          <tr >
            ...
            <td colspan="2"  align="left" class="tdeven"> <select class="inputf" size="1" name="lstDay" style="width:auto;" >
              ...
              <select class="inputf" size="1" name="lstMonth" style="width:auto;" >
                <option selected>...</option>
                <option value="01" <?if('01'==$_SESSION['post']['lstMonth']) {echo "SELECTED";}?>><?php echo MONTH_JAN?></option>
                <option value="02" <?if('02'==$_SESSION['post']['lstMonth']) {echo "SELECTED";}?>><?php echo MONTH_FEB?></option>
                <option value="03" <?if('03'==$_SESSION['post']['lstMonth']) {echo "SELECTED";}?>><?php echo MONTH_MAR?></option>
                <option value="04" <?if('04'==$_SESSION['post']['lstMonth']) {echo "SELECTED";}?>><?php echo MONTH_APR?></option>
                <option value="05" <?if('05'==$_SESSION['post']['lstMonth']) {echo "SELECTED";}?>><?php echo MONTH_MAY?></option>
                <option value="06" <?if('06'==$_SESSION['post']['lstMonth']) {echo "SELECTED";}?>><?php echo MONTH_JUN?></option>
                <option value="07" <?if('07'==$_SESSION['post']['lstMonth']) {echo "SELECTED";}?>><?php echo MONTH_JUL?></option>
                <option value="08" <?if('08'==$_SESSION['post']['lstMonth']) {echo "SELECTED";}?>><?php echo MONTH_AUG?></option>
                <option value="09" <?if('09'==$_SESSION['post']['lstMonth']) {echo "SELECTED";}?>><?php echo MONTH_SEP?></option>
                <option value="10" <?if('10'==$_SESSION['post']['lstMonth']) {echo "SELECTED";}?>><?php echo MONTH_OCT?></option>
                <option value="11" <?if('11'==$_SESSION['post']['lstMonth']) {echo "SELECTED";}?>><?php echo MONTH_NOV?></option>
                <option value="12" <?if('12'==$_SESSION['post']['lstMonth']) {echo "SELECTED";}?>><?php echo MONTH_DEC?></option>
              </select>
          ...
          <tr >
            ...
            <td colspan="2"  align="left" class="tdodd"> <select class="input" size="1" name="lstSex" >
                ...
                <option value="M" <?if('M'==$_SESSION['post']['lstSex']) {echo " SELECTED";}?>><?php echo SEX_MALE ?></option>
                <option value="F" <?if('F'==$_SESSION['post']['lstSex']) {echo " SELECTED";}?>><?php echo SEX_FEMALE ?></option>
              </select> </td>
          </tr>
          <tr >
          ...
          <tr >
            ...
            <td colspan="2"  align="left" class="tdeven">
              <select class="input" name="lstSkypeSettings" id="lstSkypeSettings" size="1"  style="width:auto;">
                ...
                <option value="ALL" <?if('ALL'==$_SESSION['post']['lstSkypeSettings']) {echo " SELECTED";}?>><?php echo SKYPE_ALL ?></option>
                <option value="HOTLIST" <?if('HOTLIST'==$_SESSION['post']['lstSkypeSettings']) {echo " SELECTED";}?>><?php echo SKYPE_HOTLIST ?></option>
              </select>
            </td>
          </tr>
              <?}?>
...
<?foreach (SMS::getList(new stdClass) as $sms){?>
                <option value="<?=$sms->id?>" <?if($sms->id==$_SESSION['post']['lstSmsCarrier']) {echo " SELECTED";}?>><?=$sms->title?></option>
<?}?>
              </select>
            </td>
          </tr>
          ...
          <tr >
            ...
            <td colspan="2"  align="left" class="tdodd"> <input type="checkbox" name="chkNews" value="1" <?if(!isset($_SESSION['post']) || isset($_SESSION['post']['chkNews'])) {echo " CHECKED";}?>  >
            </td>
          </tr>
          <tr >
            ...
            <td colspan="2"  align="left" class="tdeven"> <input type="checkbox" name="chkDisclaimer" value="1" <?if(isset($_SESSION['post']['chkDisclaimer'])) {echo " CHECKED";}?>  >
...
?>
          ...
          <tr class="tdodd" >
            ...
            <td colspan="3"><input type="checkbox" name="chkSeekmen" value="men"  <?if('men'==$_SESSION['post']['chkSeekmen']) {echo " CHECKED";}?>>
              <?php echo ADVERTISE_SEEK_M?>&nbsp; <input type="checkbox" name="chkSeekwmn" value="wmn"  <?if('wmn'==$_SESSION['post']['chkSeekwmn']) {echo " CHECKED";}?>>
              <?php echo ADVERTISE_SEEK_W?>&nbsp; <input type="hidden" name="chkSeekcpl" value="cpl"  <?if('cpl'==$_SESSION['post']['chkSeekcpl']) {echo " CHECKED";}?>>
            </td>
          </tr>
          <tr >
          ...
          <tr class="tdodd">
            ...
            ?>
              <select name="lstMySex" size="1" class="input"  >
                <option selected>- <?php echo GENERAL_CHOOSE?> -</option>
                <option value="M" <?if('M'==$_SESSION['post']['lstMySex']) {echo " SELECTED";}?>><?php echo SEX_MALE ?></option>
                <option value="F" <?if('F'==$_SESSION['post']['lstMySex']) {echo " SELECTED";}?>><?php echo SEX_FEMALE ?></option>
              </select></td>
            <td>
              <?=PRGRETUSER_AGES?>
            </td>
